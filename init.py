...
def create_config_toml(pkg_manager: str, framework: str, proj_name: str, app_id: str):
    doc = document()
    ...
    window.add('x', 40)
    window.add('y', 40)
    window.add('always_on_display', True)
...
questions = [
    ...
    {
        "name": "app_id",
        "message": "Enter application id (e.g. com.ovl.example):",
        "type": "input",
        "validate": validate_app_id,
        "invalid_message": "Must have format com.example.example",
    },
    {
